...
const MENU: Item[] = [
  ...
  { id: 's010', name: 'Cerveza Artesanal', desc: 'IPA dorada 473ml. Cerveza local de la casa', price: 2200, category: 'drinks', image: 'https://images.unsplash.com/photo-1566633806327-68e152aaf26d?w=800&q=80', details: 'IPA dorada estilo americano. 6.2% ABV. Notas citricas y florales gracias al dry-hopping con luppolo cascade. Cerveza local de Chascomus.', ingredients: ['Malta pale ale', 'Luppolo cascade', 'Levadura americana'] },
