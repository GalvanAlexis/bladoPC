...
export default function DialogBox({ speakerName, text, choices, onAskQuestion, isTyping }: DialogBoxProps) {
  ...
  return (
    <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[90%] max-w-4xl z-50">
      <div className="bg-black/80 backdrop-blur-sm border-2 border-crimson rounded-lg p-6 shadow-[0_0_30px_rgba(220,38,38,0.5)] font-mono">
          ...
          {showInput && (
            <form onSubmit={handleAsk} className="flex mt-2">
              ...
              <input 
                ...
                placeholder="Pregúntale a Blado..."
              />
            </form>
          )}
        </div>
